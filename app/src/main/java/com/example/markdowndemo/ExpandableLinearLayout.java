...
public class ExpandableLinearLayout extends LinearLayout {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.ExpandableLinearLayout);
            duration = a.getInt(R.styleable.ExpandableLinearLayout_el_duration, DEFAULT_DURATION);
            expanded = a.getBoolean(R.styleable.ExpandableLinearLayout_el_expanded, false);
            a.recycle();
        }
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            TypedArray a = c.obtainStyledAttributes(attrs, R.styleable.ExpandableLinearLayout);
            expandable = a.getBoolean(R.styleable.ExpandableLinearLayout_layout_expandable, false);
